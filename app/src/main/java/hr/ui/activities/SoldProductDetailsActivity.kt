...
import hr.dominik.ribolovnodrustvojaksic.databinding.ActivitySoldProductDetailsBinding
...
class SoldProductDetailsActivity : AppCompatActivity() {
    ...
    private fun setupUI(productDetails: SoldProduct) {
        ...
        binding.tvSoldProductTotalAmount.text = productDetails.sold_quantity
